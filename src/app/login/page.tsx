...
export default async function LoginPage({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4">
      ...
      <Card className="w-full max-w-sm shadow-xl border-0 shadow-blue-900/40 relative">
        <CardHeader className="text-center space-y-4 pb-2 pt-8">
          <div className="mx-auto flex items-center justify-center w-20 h-20 rounded-2xl bg-blue-600 shadow-lg shadow-blue-500/30">
