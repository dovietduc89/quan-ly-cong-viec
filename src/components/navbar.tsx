    ...
    <header className="sticky top-0 z-50 border-b bg-white/80 backdrop-blur-xl supports-[backdrop-filter]:bg-white/60">
      <div className="flex h-16 items-center px-4 md:px-6">
        ...
        <Link href="/" className="flex items-center gap-2.5 mr-8">
          <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-500 to-violet-500 shadow-sm">
            <CheckSquare className="h-4.5 w-4.5 text-white" />
          </div>
          <span className="font-bold text-lg hidden sm:block bg-gradient-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">
            Quản Lý Công Việc
          </span>
        </Link>
